...
double f(node& n, ifstream& pdb_bin){
    ...
    return n.cost + pdb_in_ram[index];
}
 ...
 *  - Rotación izquierda
 *  - Rotación derecha
 *  - Swap (inversión de los primeros k elementos)
 *
 ...
 */
void load_pdb(ifstream& input_bin, long long total_size) {
...
int main(int argc, char* argv[]){
    ...
    // Abre el archivo binario que contiene la Pattern Database.
    ...
    // Calcula el tamaño total de la PDB.
    long long total_size = C[N][pattern_size] * factorial[pattern_size];
    load_pdb(input_bin, total_size);
