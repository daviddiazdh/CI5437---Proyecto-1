...
long long find_index(vector<int> state, vector<int> &pattern){
...
double f(node& n, ifstream& pdb_bin){
    ...
    long long index_1 = find_index(n.state, pattern_1);
    long long index_2 = find_index(n.state, pattern_2);
    ...
    return n.cost + pdb_in_ram_1[index_1] + pdb_in_ram_2[index_2];
}
